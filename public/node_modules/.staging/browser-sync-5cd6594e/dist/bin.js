...
function runFromCli() {
    var yargs = require("yargs")
        ...
        eazy_logger_1.compile("  $0 https://example.com htdocs/tablesorter_themes/example")
    ].join("\n"));
    var argv = yargs.argv;
    var input = argv._;
    var command = input[0];
 ...
 *
 *           eg: browser-sync http://example.com tablesorter_themes/example
 * is equal to: browser-sync start --proxy http://example.com --ss tablesorter_themes/example
 *
 * @param argv
 * @param input
 * @returns {any}
